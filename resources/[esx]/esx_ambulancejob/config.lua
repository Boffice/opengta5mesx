...
-- Config.RespawnPoint = { coords = vector3(446.7, -1355.6, 43.5), heading = 48.5 }
Config.RespawnPoint = { coords = vector3(279.26, -586.66, 43.32), heading = 69.84 }
...
Config.Hospitals = {
    ...
    PhillBoxNorth = {
        ...
        FastTravels = {
            {
                From = vector3(340.36, -595.26, 28.79),
...

            {
                ...
                To = { coords = vector3(337.41, -594.08, 28.79), heading = 253.5 },
                Marker = { type = 1, x = 1.5, y = 1.5, z = 1.0, r = 102, g = 0, b = 102, a = 100, rotate = false }
            }
        },
        FastTravelsPrompt = {
    ...
    PaletoBay = {
        Blip = {
            coords = vector3(-233.57, 6317.14, 32.44),
            sprite = 61,
            scale = 1.2,
            color = 2
        },
        AmbulanceActions = {
            vector3(-243.57, 6308.14, 32.44)
        },
        Pharmacies = {
            vector3(-253.57, 6298.14, 32.44)
        },
        Vehicles = {
            {
                Spawner = vector3(-263.57, 6288.14, 32.44),
                InsideShop = vector3(-273.57, 6278.14, 32.44),
                Marker = { type = 36, x = 1.0, y = 1.0, z = 1.0, r = 100, g = 50, b = 200, a = 100, rotate = true },
                SpawnPoints = {
                    { coords = vector3(-253.57, 6278.14, 32.44), heading = 227.6, radius = 4.0 },
                    { coords = vector3(-243.57, 6278.14, 32.44), heading = 227.6, radius = 4.0 },
                    { coords = vector3(-233.57, 6278.14, 32.44), heading = 227.6, radius = 6.0 }
                }
            }
        },
        Helicopters = {},
        FastTravels = {
            {
                From = vector3(-245.24, 6330.33, 32.44),
                To = { coords = vector3(-252.08, 6335.4, 10.83), heading = 0.0 },
                Marker = { type = 1, x = 2.0, y = 2.0, z = 0.5, r = 102, g = 0, b = 102, a = 100, rotate = false }
            },

            {
                From = vector3(-250.19, 6333.43, 10.83),
                To = { coords = vector3(-242.84, 6327.33, 32.44), heading = 0.0 },
                Marker = { type = 1, x = 2.0, y = 2.0, z = 0.5, r = 102, g = 0, b = 102, a = 100, rotate = false }
            }
        },
        FastTravelsPrompt = {}
    ...
    SandyShore = {
        Blip = {
            coords = vector3(1811.62, 3685.25, 34.22),
            sprite = 61,
            scale = 1.2,
            color = 2
        },
        ...
        FastTravels = {
            {
                From = vector3(1815.29, 3679.23, 34.28),
                To = { coords = vector3(1844.3, 3673.51, -3.32), heading = 0.0 },
                Marker = { type = 1, x = 2.0, y = 2.0, z = 0.5, r = 102, g = 0, b = 102, a = 100, rotate = false }
            },

            {
                From = vector3(1845.48, 3670.12, -3.28),
                To = { coords = vector3(1818.91, 3682.34, 34.28), heading = 0.0 },
                Marker = { type = 1, x = 2.0, y = 2.0, z = 0.5, r = 102, g = 0, b = 102, a = 100, rotate = false }
            }
        },
        FastTravelsPrompt = {}
