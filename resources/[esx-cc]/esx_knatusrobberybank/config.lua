...
-- Config.RobLength = 300000
Config.RobLength = 300
Config.TimeBetween = 3600
...
Banks = {
	["fleeca"] = {
		...
		robtimeout = 3600, -- Time between roberies
	...
	["blainecounty"] = {
		...
		hackposition = { ['x'] = -104.8136, ['y'] = 6473.846, ['z'] = 31.9548 },
		reward = math.random(15000,25000),
		nameofbank = "Blaine County Savings",
		lastrobbed = 0,
		num_cops_req = 0,
		doortype = 'v_ilev_cbankvaulgate01',
		-- v_ilev_cbankvauldoor01 (vault door)
		--
        robtimeout = 3600, -- Time between roberies
	},
	...
	["PrincipalBank"] = {
		...
		lastrobbed = 0,
		robtimeout = 7200, -- Time between roberies
