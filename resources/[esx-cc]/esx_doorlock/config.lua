...
Config.DoorList = {
	...
	-- Safe bank?
	{
		-- objHash = GetHashKey('hei_v_ilev_bk_gate2_pris'), -- 746855201
		objHash = 746855201,
	...
	{
		objHash = GetHashKey('v_ilev_cbankvaulgate01'),  --1622278560, -- 0x60B201A0
		--objName = 'hei_v_ilev_bk_gate2_pris',
		objCoords  = vector3(-104.8136, 6473.846, 31.9548),
		textCoords = vector3(-104.8136, 6473.846, 31.9548),
		--objCoords  =vector3(-107.06505584717, 6474.8012695313, 31.62670135498 ),
		--textCoords = vector3(-107.06505584717, 6474.8012695313, 32.62670135498 ),
		authorizedJobs = { 'police' },
		locked = true,
		maxDistance = 12,
		size = 2
