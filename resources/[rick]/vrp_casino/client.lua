...
Citizen.CreateThread(function ()
	...
	print(source)
	vRPcasinoC.createCasinoNPCs("A_M_Y_business_01",924.35131835938, -942.13037109375, 43.3, 179.9213104248, "Richard_o_Riordan")
	vRPcasinoC.createCasinoNPCs("S_M_M_MovPrem_01",918.37469482422, -955.56658935546, 43.5, 94094848633267, "Billy_Dice")
	vRPcasinoC.createCasinoNPCs("S_M_M_MovPrem_01",918.54296875, -948.12005615234, 43.3, 179.94094848633, "Iain_Mackenzie")
end)
...
function OpenRoulettesMenu()
	...
	local elements           = {}
	elements = {
		{label = 'Bet on <font color="green">Green</font> Win Chance: <font color="red">2.7%</font>Winnings: <font color="yellow">x5</font>',  value = 'Green', times_by = 5},
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'roulettes_menu', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'chip_amount', {
			...
			align    = 'bottom-right',
			elements = {
				{label = 'Chips',  item = "casino_chip", value = 1, type = 'slider', min = 1, max = 10},
			}
